...
const ERROR_MESSAGE_MAP = {
  ...
  "cart.item.duplicate.variant": "هذا المتغير موجود في السلة بالفعل.",
  ...
  "favorite.not.found": "هذا المنتج غير موجود في المفضلة.",
  "favorite.product.not.found": "المنتج غير موجود.",
  "favorite.already.exists": "هذا المنتج موجود في المفضلة بالفعل.",
  "favorite.access.denied": "لا يمكنك تعديل هذه المفضلة.",
